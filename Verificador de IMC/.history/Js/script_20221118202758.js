...
function verificar() {
  ...
  if (soma < 18) {
    ...
    resultado.innerHTML = `<h3>O seu IMC é de ${soma} e Vo está com sobrepeso, e IMC acima do recomendado, que é de 18.5 até 24.9. É recomendado a pratica ded exercicios!!</h3>`
