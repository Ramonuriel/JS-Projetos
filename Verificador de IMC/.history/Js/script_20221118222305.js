...
function verificar() {
  ...
  if (soma < 18) {
    ...
    img.setAttribute('src', '/abaixo-peso.png')
    ...
    img.setAttribute('src', 'peso-normal.png')
    ...
    img.setAttribute('src', 'acima-peso.png')
    ...
    img.setAttribute('src', 'obesidade-grau1.png')
    ...
    img.setAttribute('src', 'obesidade-grau2.png')
  } else {
    ...
    img.setAttribute('src', 'obesidade-grau3.png')
  }
}
