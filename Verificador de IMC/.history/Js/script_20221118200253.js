...
function verificar() {
  ...
  if (soma < 18) {
    ...
    resultado.innerHTML = `<h3>O seu IMC é de ${soma} e está com Obesidade Grau 1, e IMC acima do recomendado, que é de 18.5 até 24.9. É recomendado a procura de um Nutricionista e </h3>`
